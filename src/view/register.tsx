    ...
    return <section className={'w-full h-screen  bg-gray-300 '}>
        ...
        <div
            ...
            <div className={'w-[70%] h-[50%] absolute left-0 right-0 top-0 bottom-0 m-auto'}>
                <CustomInput type={'text'} name={'username'} placeholder={'Enter Your User Name'} className={'w-full h-full border-[2px] border-gray-300 outline outline-0 focus:outline-0'}/>
                <CustomInput type={'password'} name={'password'} placeholder={'Enter Your Password'} className={'w-full h-full border-[2px] border-gray-300 outline outline-0 focus:outline-0 mt-8'}/>
                {/*<input
                    name="username"
                    type="text"
                ...
                <button
                    className={'w-full h-[25%] bg-black text-white absolute bottom-[10%] left-0 text-[20px] hover:bg-[#98A86D]'}>Sing
                    In
                </button>
            </div>
        ...
        <div
            ...
            <div className={'w-[70%] h-[60%] absolute left-0 right-0 top-[10%] bottom-0 m-auto'}>
                <CustomInput type={'text'} name={'username'} placeholder={'Enter Your User Name'} className={'w-full h-full border-[2px] border-gray-300 outline outline-0 focus:outline-0'}/>
                <CustomInput type={'email'} name={'email'} placeholder={'Enter Your Email'} className={'w-full h-full border-[2px] border-gray-300 outline outline-0 focus:outline-0 mt-7'}/>
                <CustomInput type={'password'} name={'password'} placeholder={'Enter Your Password'} className={'w-full h-full border-[2px] border-gray-300 outline outline-0 focus:outline-0 mt-16'}/>
            ...
            <button
                className={'w-[70%] h-[13%] bg-black text-white absolute bottom-[5%] left-0 right-0 m-auto text-[20px] hover:bg-[#98A86D]'}>Sing
                Up
            </button>
        </div>
