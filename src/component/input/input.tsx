    ...
    return<div className={''}>
        ...
        <input
            ...
            bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0
             ...
             focus:border-t-transparent text-sm mt-[30px] mb-[-30px] rounded-[7px] border-blue-gray-200 focus:border-blue-500 flex flex-col left-0 right-0 top-0 bottom-0 m-auto"
             /><label
        htmlFor={props.name}
