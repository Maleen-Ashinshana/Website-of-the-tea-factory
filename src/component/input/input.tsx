...
function Input(props: Props) {
    return<div className={''}>
        ...
        peer-disabled:peer-placeholder-shown:text-blue-gray-500 transition-all  -top-[12.9px]  peer-placeholder-shown:text-sm text-[11px] peer-focus:text-[11px] before:content[' '] before:block before:box-border before:w-2.5 before:h-1.5 before:mt-[6.5px] before:mr-1
