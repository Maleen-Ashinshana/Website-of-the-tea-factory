    ...
    return<div className={''}>
        ...
        <input
            ...
            bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0
             ...
             focus:border-t-transparent text-sm  rounded-[7px] border-blue-gray-200 focus:border-blue-500 flex left-0 right-0 top-0 bottom-0 m-auto"
             /><label
        htmlFor={props.name}
        ...
        peer-disabled:peer-placeholder-shown:text-blue-gray-500 transition-all -top-[42px]  peer-placeholder-shown:text-sm text-[11px] peer-focus:text-[11px] before:content[' '] before:block before:box-border before:w-2.5 before:h-1.5 before:mt-[6.5px] before:mr-1
        ...
        after:block after:flex-grow after:box-border after:w-2.5 after:h-1.5 after:mt-[6.5px] after:ml-1 peer-placeholder-shown:after:border-transparent after:rounded-tr-md after:border-t peer-focus:after:border-t-2 after:border-r peer-focus:after:border-r-2 after:pointer-events-none
         after:transition-all peer-disabled:after:border-transparent peer-placeholder-shown:leading-[3.75] text-blue-gray-400 peer-focus:text-blue-500 before:border-blue-gray-200 peer-focus:before:!border-blue-500 after:border-blue-gray-200 peer-focus:after:!border-blue-500 flex left-0 right-0 top-0 bottom-0 m-auto">{props.label}
    </label>
    </div>
